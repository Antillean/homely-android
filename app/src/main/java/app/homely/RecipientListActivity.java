 ...
 * {@link RecipientListFragment} and the item details
 * (if present) is a {@link RecipientDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link RecipientListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class RecipientListActivity extends AppCompatActivity
        implements RecipientListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recipient_app_bar);
        ...
        if (findViewById(R.id.recipient_detail_container) != null) {
            ...
            ((RecipientListFragment) getSupportFragmentManager()
                    .findFragmentById(R.id.recipient_list))
    ...
    /**
     * Callback method from {@link RecipientListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(RecipientDetailFragment.ARG_ITEM_ID, id);
